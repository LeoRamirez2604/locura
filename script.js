...
const usersDB = [
  { username: "Leonardo", password: "Rayados1", email: "leonardo@example.com" },
  { username: "Cristiano", password: "GOAT", email: "cristiano@example.com" },
];
  ...
  if (protectedRoutes.includes(view) && !isAuthenticated) {
    ...
    if (view === "datatable") {
      $("#product-table").DataTable({
        ...
        "paging": false, // Desactiva paginación ("Previous/Next").
